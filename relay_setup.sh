...
RELAY_STATIC_IP="192.168.59.81/28"
SUBNET="192.168.59.80/28"
POOL="192.168.59.82 - 192.168.59.82"
ROUTER="192.168.59.81"
# ──────────────────────────────────────────────────────────────────

echo "============================================"
echo "  RELAY SETUP — paabinye-brown / Y=59"
echo "============================================"
echo ""
...
echo "============================================"
echo "  ${IFACE_INTERNAL} IP  : 192.168.59.2/29 (from Gateway Kea)"
echo "  ${IFACE_BRIDGE}   IP  : 192.168.59.81/28 (static)"
echo "  Kea subnet   : 192.168.59.80/28"
echo "  Kea pool     : 192.168.59.82 (Node only)"
echo "============================================"
echo ""
echo "  Final interface state:"
ip --brief address
echo ""
echo "  Verify Gateway gave us 192.168.59.2 on ${IFACE_INTERNAL}."
