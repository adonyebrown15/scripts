...
echo "============================================"
echo "  NODE SETUP — paabinye-brown / Y=53"
echo "============================================"
...
echo "============================================"
echo "  Expected: ${IFACE_BRIDGE} = 192.168.53.82/28"
echo "  Expected: default gateway = 192.168.53.81"
echo "============================================"
echo ""
echo "  Run these tests to verify the full chain:"
echo "    ping -c 4 192.168.53.81   # Relay"
echo "    ping -c 4 192.168.53.1    # Gateway"
