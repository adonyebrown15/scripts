...
echo "============================================"
echo "  NODE SETUP — paabinye-brown / Y=99"
echo "============================================"
...
echo "============================================"
echo "  Expected: ${IFACE_BRIDGE} = 192.168.99.82/28"
echo "  Expected: default gateway = 192.168.99.81"
echo "============================================"
echo ""
echo "  Run these tests to verify the full chain:"
echo "    ping -c 4 192.168.99.81   # Relay"
echo "    ping -c 4 192.168.99.1    # Gateway"
